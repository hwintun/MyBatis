package com.github.hwintun.controllor;
...
import com.github.hwintun.model.StudentLogin;
import com.github.hwintun.service.StudentService;
...
public class StudentController {
	...
	public String signup(@ModelAttribute("student") Student student, Model model) {
		if(studentService.getStudentByUserName(student.getUserName())) {
			...
			model.addAttribute("message", "Saved student detail");
